                        ...
                        <div class="restaurant_payout_create-inner">
                            ...
                            <fieldset>
                                ...
                                <div class="form-group row width-50">
                                    ...
                                    <div class="col-7">
                                        <select id='restaurant_cuisines1' class="form-control" required>
                                ...
                                <div class="form-group row width-50">
                                    ...
                                    <div class="col-7">
                                        <select id='restaurant_cuisines3' class="form-control" required>
                                            <option value="">{{ trans("lang.select_cuisines") }}</option>
                                        </select>
                                        <div class="form-text text-muted">
                                            {{ trans("lang.restaurant_cuisines_help") }}
...
<script>
    ...
    $(".create_restaurant_btn").click(function () {
        ...
        var categoryTitle3 = $("#restaurant_cuisines2 option:selected").text();
